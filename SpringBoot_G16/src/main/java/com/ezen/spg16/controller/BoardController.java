...
public class BoardController {
	...
	// 위의 방법이 안되는 이유 > enctype 이라서 multipart를 해야하는데 뭔가 값이 전달이 안된다? 그걸 해결하는방법
	...
	public String reply_delete(@RequestParam("num") int num,@RequestParam("boardnum") int boardnum
	...
	public String board_edit(@RequestParam("num") int num, @RequestParam("pass") String pass,
